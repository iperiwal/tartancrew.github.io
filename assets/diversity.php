        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="../index">
                        <img src="../assets/images/crest" alt="" width="40%" height="40%">
                    </a>
                </div>
                <!-- /logo -->
            </div>
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <div class="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <div class="dropdown">
                                <button class="dropbtn">News <span class="caret"></span></a>
                            ...
                            <div class="dropdown">
                                <button class="dropbtn">DONATE <span class="caret"></span></a>
                                  <i class="fa fa-caret-down"></i>
                                </button>
                                <div class="dropdown-content">
                                    <li><a href="rentarower">Rent A Rower</a></li>
...
<!--             CMU Crew is committed to asdfasd, The Diversity and Inclusion committee was formed at the start of the 2020 fall semester to work asdfadsf.  The goal of the committee is to continue to work towards fostering a mo 
